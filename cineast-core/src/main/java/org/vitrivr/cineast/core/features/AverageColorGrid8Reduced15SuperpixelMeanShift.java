...
public class AverageColorGrid8Reduced15SuperpixelMeanShift extends AverageColorGrid8 {
  ...
  public AverageColorGrid8Reduced15SuperpixelMeanShift() {
    super("features_AverageColorGrid8Reduced15SuperpixelMeanShift", 12595f / 4f);
  }
