...
public class CLDReduced15SuperpixelWatershed extends AbstractFeatureModule {
  ...
  public CLDReduced15SuperpixelWatershed() {
    super("features_CLDReduced15SuperpixelWatershed", 1960f / 4f, 12);
  }
