...
public class AverageFuzzyHistNormalizedSuperpixelSlic extends AbstractFeatureModule {
  ...
  public AverageFuzzyHistNormalizedSuperpixelSlic() {
    super("features_AverageFuzzyHistNormalizedSuperpixelSlic", 2f / 4f, 15);
  }
