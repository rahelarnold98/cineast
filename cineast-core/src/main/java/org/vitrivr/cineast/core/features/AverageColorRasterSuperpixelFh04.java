...
public class AverageColorRasterSuperpixelFh04 extends AbstractFeatureModule {
  ...
  public AverageColorRasterSuperpixelFh04() {
    super("features_AverageColorRasterSuperpixelFh04", 1, 1);
  }
