...
public class MedianFuzzyHistSuperpixelSlic extends AbstractFeatureModule {
  ...
  public MedianFuzzyHistSuperpixelSlic() {
    super("features_MedianFuzzyHistSuperpixelSlic", 2f / 4f, 15);
  }
