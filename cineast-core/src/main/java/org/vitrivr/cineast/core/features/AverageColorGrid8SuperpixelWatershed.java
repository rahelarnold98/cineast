...
public class AverageColorGrid8SuperpixelWatershed extends AbstractFeatureModule {
  ...
  public AverageColorGrid8SuperpixelWatershed() {
    super("features_AverageColorGrid8SuperpixelWatershed", 12595f / 4f, 192);
  }

  protected AverageColorGrid8SuperpixelWatershed(String tableName, float maxDist) {
