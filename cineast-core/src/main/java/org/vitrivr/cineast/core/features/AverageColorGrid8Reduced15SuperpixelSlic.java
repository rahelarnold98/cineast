...
public class AverageColorGrid8Reduced15SuperpixelSlic extends AverageColorGrid8 {
  ...
  public AverageColorGrid8Reduced15SuperpixelSlic() {
    super("features_AverageColorGrid8Reduced15SuperpixelSlic", 12595f / 4f);
  }
