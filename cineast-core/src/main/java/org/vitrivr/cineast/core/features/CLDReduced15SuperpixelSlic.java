...
public class CLDReduced15SuperpixelSlic extends AbstractFeatureModule {
  ...
  public CLDReduced15SuperpixelSlic() {
    super("features_CLDReduced15SuperpixelSlic", 1960f / 4f, 12);
  }
