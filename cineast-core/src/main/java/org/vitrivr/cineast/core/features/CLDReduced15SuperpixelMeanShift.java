...
public class CLDReduced15SuperpixelMeanShift extends AbstractFeatureModule {
  ...
  public CLDReduced15SuperpixelMeanShift() {
    super("features_CLDReduced15SuperpixelMeanShift", 1960f / 4f, 12);
  }
