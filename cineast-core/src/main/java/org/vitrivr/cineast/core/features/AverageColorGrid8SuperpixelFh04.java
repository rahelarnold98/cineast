...
public class AverageColorGrid8SuperpixelFh04 extends AbstractFeatureModule {
  ...
  public AverageColorGrid8SuperpixelFh04() {
    super("features_AverageColorGrid8SuperpixelFh04", 12595f / 4f, 192);
  }

  protected AverageColorGrid8SuperpixelFh04(String tableName, float maxDist) {
