...
public class AverageColorRasterSuperpixelSlic extends AbstractFeatureModule {
  ...
  public AverageColorRasterSuperpixelSlic() {
    super("features_AverageColorRasterSuperpixelSlic", 1, 1);
  }
  ...
  Pair<float[], float[]> computeRaster(SegmentContainer shot) {
    ...
    MultiImage avg = factory.newMultiImage(superpixel);
  ...
  private BufferedImage applySuperpixel(SegmentContainer segmentContainer) {
    return Superpixel.applySuperpixelSC(segmentContainer, Superpixel.IMG_AVG, Superpixel.ALG_SLIC);
  }
