...
public class AverageColorRasterSuperpixelWatershed extends AbstractFeatureModule {
  ...
  public AverageColorRasterSuperpixelWatershed() {
    super("features_AverageColorRasterSuperpixelWatershed", 1, 1);
  }
  ...
  private BufferedImage applySuperpixel(SegmentContainer segmentContainer) {
    return Superpixel.applySuperpixelSC(segmentContainer, Superpixel.IMG_AVG,
